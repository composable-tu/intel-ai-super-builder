...
## Known Issues
- **Hardware virtualization is required.** If installation fails, enable Intel VT-x, Intel Virtualization Technology, AMD-V, or SVM Mode in BIOS/UEFI, restart Windows, and run the installer again. On managed PCs, contact your IT administrator if the setting is locked.
