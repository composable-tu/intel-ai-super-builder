...
### 1. [Generated MCP Servers (mcp_codegen)](./GENERATED_MCP_SERVERS.md)
Learn how to build and deploy custom MCP servers using our autogen framework. Includes:
- Building executables and running with PowerShell scripts
- Configuration and setup instructions
- Demo videos for Business Travel Agent and Mind Map Generator

### 2. [Open Source MCP Servers](./OPEN_SOURCE_MCP_SERVERS.md)
Set up community-maintained MCP servers from the official Model Context Protocol repository. Covers:
- Installation methods (pip, uvx, npx)
- Troubleshooting dependencies and environment variables
